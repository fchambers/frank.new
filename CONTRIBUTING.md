...
models. At this time, Bolt supports using OpenAI's GPT-4o Mini.
You can get an API key from the [OpenAI Platform](https://platform.openai.com/api-keys) to use with Bolt.
